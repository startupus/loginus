...
import { UserFamilyGroup } from '../../../family/entities/user-family-group.entity';
...
@Module({
  imports: [
    TypeOrmModule.forFeature([Invitation, User, UserRoleAssignment, Role, Team, TeamRole, TeamMembership, Organization, OrganizationRole, OrganizationMembership, FamilyGroup, UserFamilyGroup]),
    UsersModule,
    RbacModule,
    NotificationsModule,
  ],
