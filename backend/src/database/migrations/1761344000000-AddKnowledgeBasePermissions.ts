  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      VALUES 
        ...
        ('00000000-0000-0000-0000-000000000904', 'knowledge.items.approve', 'Подтверждение материалов', 'knowledge.items', 'approve', NOW(), NOW()),
        ('00000000-0000-0000-0000-000000000905', 'knowledge.items.publish', 'Публикация материалов', 'knowledge.items', 'publish', NOW(), NOW()),
        ('00000000-0000-0000-0000-000000000906', 'knowledge.items.review', 'Подтверждение качества материала', 'knowledge.items', 'review', NOW(), NOW()),
