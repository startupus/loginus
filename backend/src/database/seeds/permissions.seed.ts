export const SYSTEM_PERMISSIONS = [
  ...
  {
    name: 'knowledge.items.approve',
    resource: 'knowledge.items',
    action: 'approve',
    description: 'Подтверждение материалов',
  },
  {
    name: 'knowledge.items.publish',
    resource: 'knowledge.items',
    action: 'publish',
    description: 'Публикация материалов',
  },
  {
    name: 'knowledge.items.review',
    resource: 'knowledge.items',
    action: 'review',
    description: 'Подтверждение качества материала',
  },
