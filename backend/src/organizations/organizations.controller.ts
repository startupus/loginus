...
export class OrganizationsController {
  ...
  async createOrganization(
    ...
    const organization = await this.organizationsService.createOrganization(dto, user.userId);
    return {
      success: true,
      data: organization,
    };
  ...
  async getUserOrganizations(@CurrentUser() user: any) {
    const organizations = await this.organizationsService.getUserOrganizations(user.userId);
    return {
      success: true,
      data: organizations,
    };
  ...
  async getOrganization(@Param('id') id: string) {
    const organization = await this.organizationsService.getOrganizationById(id);
    return {
      success: true,
      data: organization,
    };
  ...
  async updateOrganization(
    ...
    const organization = await this.organizationsService.updateOrganization(id, dto, user.userId);
    return {
      success: true,
      data: organization,
    };
